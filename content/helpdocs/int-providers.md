...
> **Required** for Cloud mode and platform-side LLM features (e.g. PRD-gen for backlog). Optional for Local mode if using CLI subscriptions.
...
| **PRD-gen for backlog** | Uses your Anthropic key to extract backlog items from the project's PRD |
