...
| **Access Token** | Dashboard → Personal Settings → Tokens | Read-only API access — powers `{{brand.cli.binName}} workers status` (Management API queries). Optional unless you want deploy-status visibility on the platform Status page |
