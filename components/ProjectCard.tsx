...
export interface Sprint {
  ...
  /** Sprint shape (mig 117 + 169 — discovery / planning / execution / review).
   *  Surfaced in the sprint history list so the operator can tell at a glance
   *  what kind of sprint each row was. */
  intent?: string | null;
...
export interface ProjectSettings {
  ...
  /** Set by pip_import RPC (mig 210) on the real project materialised
   *  from a Project Inception Pack. Drives the "PIP" badge. */
  created_via_pip?: boolean;
  [key: string]: unknown;
}
    ...
    <div style={{ borderTop: "1px solid var(--surface0)" }}>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        >
          ...
          <IntentBadge intent={s.intent ?? null} />
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8, marginBottom: 8 }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              {(project.settings as { created_via_pip?: boolean } | undefined)?.created_via_pip && (
                <span
                  title="Materialised from a Project Inception Pack"
                  style={{
