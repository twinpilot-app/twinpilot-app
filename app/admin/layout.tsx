...
import { LayoutDashboard, Users, ChevronLeft, ShieldAlert, Plug, PowerOff, Ticket, Bell, ClipboardList, Shield, Rocket, Database, Library, Bot } from "lucide-react";

const NAV = [
  { href: "/admin",                  label: "Overview",         icon: LayoutDashboard },
  { href: "/admin/tenants",          label: "Tenants",          icon: Users           },
  { href: "/admin/storage",          label: "Storage",          icon: Database        },
  { href: "/admin/curated-repos",    label: "Curated Repos",    icon: Library         },
  { href: "/admin/platform-agents",  label: "Platform Agents",  icon: Bot             },
