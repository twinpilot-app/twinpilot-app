...
import { MarketplaceImportSkillSchema } from "@/lib/api-schemas";
...
export async function POST(req: NextRequest) {
  try {
    const body = await parseBody(req, MarketplaceImportSkillSchema);
    ...
    if (!skillSlug || !targetFactoryId) {
      throw new ValidationError("skillSlug and targetFactoryId are required", []);
    }
